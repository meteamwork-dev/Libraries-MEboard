...
|`calAI1`|`int16_t`|`60`|ค่าตัวแปรสำหรับสอบเทียบ AI วิธีใช้งานนำไปใส่คำสั่ง AISet |
|`calAI2`|`int16_t`|`61`|ค่าตัวแปรสำหรับสอบเทียบ AI วิธีใช้งานนำไปใส่คำสั่ง AISet |
|`calAI3`|`int16_t`|`62`|ค่าตัวแปรสำหรับสอบเทียบ AI วิธีใช้งานนำไปใส่คำสั่ง AISet |
|`calAI4`|`int16_t`|`63`|ค่าตัวแปรสำหรับสอบเทียบ AI วิธีใช้งานนำไปใส่คำสั่ง AISet |
